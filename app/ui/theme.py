...
QLabel#Brand { color: white; font-size: 22px; font-weight: 700; padding: 20px 14px; }
QPushButton#NavButton { color: #cbd5e1; text-align: left; border: none; border-radius: 8px; padding: 11px 14px; }
