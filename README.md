...
- 复习页“怎么记”使用受约束的小模型场景联想，例句—释义钩子与挖空回忆题由当前词卡确定性生成；无例句词条使用“单词＝释义”和“中文义 → 英文填空”，模型编造的词根、谐音或空泛建议不会直接展示；
